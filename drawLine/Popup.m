...
- (void)setupSubtitle {
    ...
    if (pSubTitle) {
        ...
        pSubTitle = [pSubTitle stringByReplacingOccurrencesOfString:@"\\n" withString:@"\n"];
...
//    }
    ...
    if (pSuccessTitle) {
        ...
        [successBtn setFrame:CGRectMake(popupView.frame.size.width/2 -50, popupView.frame.size.height - 48, 100, 40)];
